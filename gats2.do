...
putexcel A1=matrix(r(table)', names) using "gats2", sheet(anyslt7) modify

proportion anyslt [pweight=gatsweight], over(a01)
putexcel A5=matrix(r(table)', names) using "gats2", sheet(anyslt7) modify

proportion anyslt [pweight=gatsweight], over(state)
putexcel A15=matrix(r(table)', names) using "gats2", sheet(anyslt7) modify

proportion anyslt [pweight=gatsweight], over(a01 state)
putexcel A90=matrix(r(table)', names) using "gats2", sheet(anyslt7) modify

//proportions anysmok
proportion anysmoke [pweight=gatsweight]
putexcel A1=matrix(r(table)', names) using "gats2", sheet(anysmoke7) modify

proportion anysmoke [pweight=gatsweight], over(a01)
putexcel A5=matrix(r(table)', names) using "gats2", sheet(anysmoke7) modify

proportion anysmoke [pweight=gatsweight], over(state)
putexcel A15=matrix(r(table)', names) using "gats2", sheet(anysmoke7) modify

proportion anysmoke [pweight=gatsweight], over(a01 state)
putexcel A90=matrix(r(table)', names) using "gats2", sheet(anysmoke7) modify

//proportions anytob
proportion anytob [pweight=gatsweight]
putexcel A1=matrix(r(table)', names) using "gats2", sheet(anytob7) modify

proportion anytob [pweight=gatsweight], over(a01)
putexcel A5=matrix(r(table)', names) using "gats2", sheet(anytob7) modify

proportion anytob [pweight=gatsweight], over(state)
putexcel A15=matrix(r(table)', names) using "gats2", sheet(anytob7) modify

proportion anytob [pweight=gatsweight], over(a01 state)
putexcel A90=matrix(r(table)', names) using "gats2", sheet(anytob7) modify
